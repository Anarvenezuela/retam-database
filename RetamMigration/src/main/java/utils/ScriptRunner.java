 ...
 * found at: https://github.com/BenoitDuffez/ScriptRunner
 */
 /*
...
public class ScriptRunner {
     ...
     */
    public static final Pattern DELIM_P = Pattern.compile("^\\s*(--)?\\s*delimiter\\s*=?\\s*([^\\s]+)+\\s*.*$", Pattern.CASE_INSENSITIVE);
    ...
    private void runScript(Connection conn, Reader reader) throws IOException,
        ...
        try {
            ...
            while ((line = lineReader.readLine()) != null) {
                ...
                final Matcher delimMatch = DELIM_P.matcher(trimmedLine);
